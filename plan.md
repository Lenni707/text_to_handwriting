...
- **Recent Updates**:
  ...
  - Added an **Ink Color** selection panel featuring 5 color presets (Navy, Black, Green, Red, Purple) and a custom color picker button, syncing selection to `localStorage`.
...
- [x] Add an **Ink Color** selection panel (presets + custom color picker).
